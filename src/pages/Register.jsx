...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        if (!hasAgreedToLegal) {
            return setError('You must agree to the Terms and Conditions and Privacy Policy to register.');
        }
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <div className="terms-consent">
                        <input
                            ...
                            onChange={(e) => {
                                setHasAgreedToLegal(e.target.checked);
                                if (error) setError('');
                            }}
                        />
                        <label htmlFor="terms-consent" className="terms-consent__label">
                            I agree to the{' '}
                    ...
                    <button type="submit" disabled={!hasAgreedToLegal}>Register</button>
                </form>
